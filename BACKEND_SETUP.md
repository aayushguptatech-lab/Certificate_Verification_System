...
npm init -y
npm install express cors mysql2 dotenv bcryptjs jsonwebtoken multer
...
JWT_ACCESS_SECRET=your_access_secret_key_here_min_16_chars
JWT_REFRESH_SECRET=your_refresh_secret_key_here_min_16_chars
