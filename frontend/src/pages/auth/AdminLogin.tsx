...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await authService.adminLogin(formData.adminId, formData.password)
        ...
        <Card className="border-2 border-primary border-opacity-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
              ...
              <p className="text-blue-800">Admin ID: <span className="font-mono">admin@certified.local</span></p>
