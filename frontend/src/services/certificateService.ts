...
class CertificateService {
  ...
  /**
   * Track certificate verification status by certificateId
   */
  async trackStatus(certificateId: string): Promise<TrackingResult> {
    return apiClient.get<TrackingResult>(API_ENDPOINTS.CERTIFICATES.TRACK, { certificateId })
  }
}
