  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setVerificationData({
        ...
        course: 'Advanced Certificate in Full Stack Development',
        status: 'AUTHENTIC',
        verificationCode: 'VER-2024-' + Math.random().toString(36).substr(2, 9).toUpperCase()
      })
    }, 1000)
  }
                ...
                <div className="space-y-4 border-t border-b border-gray-200 py-6 my-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="font-semibold text-gray-900">{verificationData.course}</p>
                    </div>
                  </div>
                </div>
            ...
            {verificationStatus === 'error' && (
              <div className="card border-2 border-red-500">
                <div className="text-center">
                  ...
                  <p className="text-red-600 mt-2">Please fill in all required fields correctly</p>
                </div>
              </div>
            )}
          </div>
